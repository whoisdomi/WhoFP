...
private:
  ...
  QSet<QString> deviceManagementKeys = {"AutomaticUpdates", "DeviceShutdown", "HigherBitrate", "IncreaseThermalLimits", "LowVoltageShutdown", "NoLogging", "NoUploads", "UseKonikServer"};
