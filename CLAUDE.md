...
For detailed checklists and variable references, see the subdirectory CLAUDE.md files:
- **UI settings:** `frogpilot/ui/CLAUDE.md`
- **Lateral tuning:** `frogpilot/controls/CLAUDE.md`

> **Maintenance rule:** When modifying any tuning variable, default value, or file path related to lateral control — update `frogpilot/controls/CLAUDE.md` and its identical siblings `AGENTS.md` and `GEMINI.md` in the same directory.
