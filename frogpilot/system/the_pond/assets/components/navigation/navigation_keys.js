...
export function NavKeys() {
  ...
  const meta = {
    amap1:  { prop: "amap1Key",  saved: "savedA1",     edit: "editA1",     prefix: "",    body: "amap1"  },
    amap2:  { prop: "amap2Key",  saved: "savedA2",     edit: "editA2",     prefix: "",    body: "amap2"  },
    public: { prop: "publicKey", saved: "savedPublic", edit: "editPublic", prefix: "pk.", body: "public" },
    secret: { prop: "secretKey", saved: "savedSecret", edit: "editSecret", prefix: "sk.", body: "secret" }
  }
          ...
          return html`
            ...
            <div class="navkeys-row">
              ...
              <button
                ...
                @click="${() => state[keyMeta.saved] ? api.delete(kind)() : api.save(kind)()}">
