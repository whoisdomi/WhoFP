...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"CancelDownloadMaps", {CLEAR_ON_MANAGER_START, STRING, "0", "0"}},
    ...
    {"DrivingModel", {PERSISTENT, STRING, "sc-driving_default", "sc-driving_default", 1}},
    {"DrivingModelName", {PERSISTENT, STRING, "SC driving (Default)", "SC driving (Default)", 1}},
