...
For detailed checklists and variable references, see the subdirectory GEMINI.md files:
- **UI settings:** `frogpilot/ui/GEMINI.md`
- **Lateral tuning:** `frogpilot/controls/GEMINI.md`

> **Maintenance rule:** When modifying any tuning variable, default value, or file path related to lateral control — update `frogpilot/controls/GEMINI.md` and its identical siblings `CLAUDE.md` and `AGENTS.md` in the same directory.
