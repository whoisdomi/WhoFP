...
std::unordered_map<std::string, uint32_t> keys = {
    ...
    {"AdvancedTurnDesires", PERSISTENT},
    {"ATDSpeedMax", PERSISTENT},
    {"ATDSteeringMin", PERSISTENT},
    {"ATDLeftTurnBiasPercent", PERSISTENT},
    {"ATDRightTurnBiasPercent", PERSISTENT},
    {"ATDMinBiasAbsolute", PERSISTENT},
    {"ATDTurnLatSmooth", PERSISTENT},
    {"ATDPostTurnFrames", PERSISTENT},
    {"ATDDeactivationSteeringExtreme", PERSISTENT},
    {"ATDDeactivationSteeringEarly", PERSISTENT},
    {"ATDSteeringDecreaseRatio", PERSISTENT},
    {"ATDDebugEnabled", PERSISTENT},
    ...
    {"SteerKF", PERSISTENT},
    {"SteerKFStock", PERSISTENT},
    {"SteerKD", PERSISTENT},
    {"SteerKDStock", PERSISTENT},
