...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"CSCLateralAccelerationOffset", {PERSISTENT, FLOAT, "0.0", "0.0", 1}},
    ...
    {"LowSpeedTurnCalibrationProgress", {PERSISTENT, FLOAT, "0.0", "0.0", 3}},
    {"LowSpeedTurnSpeedController", {PERSISTENT, BOOL, "0", "0", 1}},
    {"LowSpeedTurnTorqueData", {PERSISTENT | DONT_LOG, JSON, "{}", "{}"}},
    {"LSTSCCalibrateMode", {PERSISTENT, BOOL, "0", "0", 1}},
    ...
    {"ShowLSTSCStatus", {PERSISTENT, BOOL, "1", "0", 2}},
