...
class LongitudinalPlanner:
  ...
  @staticmethod
  def parse_model(model_msg, v_ego, taco_tune, taco_tune_aggressiveness):
    ...
    # FrogPilot variables
    if taco_tune:
      max_lat_accel = np.interp(v_ego, [5, 10, 20], [1.5, 2.0, 3.0]) * taco_tune_aggressiveness
  ...
  def update(self, sm, frogpilot_toggles):
    ...
    x, v, a, j, throttle_prob = self.parse_model(sm['modelV2'], v_ego, frogpilot_toggles.taco_tune, frogpilot_toggles.taco_tune_aggressiveness)
