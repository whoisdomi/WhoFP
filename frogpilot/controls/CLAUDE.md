...
> **Maintenance rule:** If you discover a new tuning variable, change a default value, find a new file path, or learn a new tuning tip from testing — update this file as part of the same task. Also update the identical files at `frogpilot/controls/AGENTS.md` and `frogpilot/controls/GEMINI.md`.
