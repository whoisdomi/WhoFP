...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"AutoPrebuiltEnabled", {PERSISTENT, BOOL, "0", "0", 0}},
    ...
    {"CustomButtonControl", {PERSISTENT, INT, "0", "0", 2}},
    ...
    {"EcuDisableFailed", {CLEAR_ON_MANAGER_START, BOOL, "0", "0", 0}},
    ...
    {"LaneChangeDuration", {PERSISTENT, INT, "10", "10", 1}},
    {"LaneChangeJerkResponse", {PERSISTENT, INT, "10", "10", 1}},
    {"LaneChangeLateralAccel", {PERSISTENT, INT, "10", "10", 1}},
    ...
    {"LanePositionOffset", {PERSISTENT, FLOAT, "0.0", "0.0", 2}},
    ...
    {"LongCustomButtonControl", {PERSISTENT, INT, "0", "0", 2}},
    ...
    {"SLCPriorityMode", {PERSISTENT, BOOL, "0", "0", 2}},
    ...
    {"SLCSetOverrideSpeed", {CLEAR_ON_MANAGER_START, FLOAT, "0", "0"}},
    ...
    {"AdvancedTurnDesires", {PERSISTENT, BOOL, "0", "0", 2}},
    {"TurnLatSmooth", {PERSISTENT, FLOAT, "0.05", "0.05", 2}},
    ...
    {"VeryLongCustomButtonControl", {PERSISTENT, INT, "0", "0", 2}},
