...
private:
  ...
  QSet<QString> qolKeys = {"CustomCruise", "CustomCruiseLong", "ForceStops", "ICBM", "IncreasedStoppedDistance", "MapGears", "ReverseCruise", "SetSpeedOffset", "WeatherPresets"};
  ...
  QSet<QString> speedLimitControllerVisualKeys = {"ShowSLCOffset", "SLCPriorityMode", "SpeedLimitSources"};
