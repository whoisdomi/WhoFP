...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"LowSpeedTurnSpeedController", {PERSISTENT, BOOL, "0", "0", 2}},
    {"LowSpeedTurnTorqueData", {PERSISTENT, JSON, "{}", "{}"}},
    {"LowSpeedTurnCalibrationProgress", {PERSISTENT, FLOAT, "0.0", "0.0"}},
    {"LSTSCCalibrateMode", {PERSISTENT, BOOL, "0", "0", 2}},
