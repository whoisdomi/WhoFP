...
def convert_params(params_cache):
  ...
  if Path("/cache/tracking").exists():
    ...
    frogpilot_stats["FrogPilotKilometers"] = params_tracking.get_float("FrogPilotKilometers")
    frogpilot_stats["FrogPilotMinutes"] = params_tracking.get_float("FrogPilotMinutes")
