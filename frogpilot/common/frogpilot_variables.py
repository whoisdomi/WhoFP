...
class FrogPilotVariables:
  ...
  def update(self, holiday_theme="stock", started=False):
    ...
    toggle.taco_tune_max_steer = self.get_value("TacoTuneMaxSteer", cast=int, condition=toggle.taco_tune_hack, default=409)
    toggle.taco_tune_delta_up = self.get_value("TacoTuneDeltaUp", cast=int, condition=toggle.taco_tune_hack, default=3)
    toggle.taco_tune_delta_down = self.get_value("TacoTuneDeltaDown", cast=int, condition=toggle.taco_tune_hack, default=5)
