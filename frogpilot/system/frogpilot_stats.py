...
def send_stats():
  try:
    ...
    point = (Point("user_stats")
      ...
      .field("total_aol_seconds", int(frogpilot_stats.get("AOLTime", 0)))
      .field("total_lateral_seconds", int(frogpilot_stats.get("LateralTime", 0)))
      .field("total_longitudinal_seconds", int(frogpilot_stats.get("LongitudinalTime", 0)))
      .field("total_tracked_seconds", int(frogpilot_stats.get("TrackedTime", 0)))
