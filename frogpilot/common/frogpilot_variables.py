...
class FrogPilotVariables:
  ...
  def update(self, holiday_theme="stock", started=False):
    ...
    toggle.steer_delta_up = self.get_value("SteerDeltaUp", cast=int, condition=quality_of_life_lateral, min=3, max=10)
    toggle.steer_delta_down = self.get_value("SteerDeltaDown", cast=int, condition=quality_of_life_lateral, min=3, max=10)
    toggle.steer_max = self.get_value("SteerMax", cast=int, condition=quality_of_life_lateral, min=250, max=500)
