...
class CarControllerParams:
  ...
  def __init__(self, CP, vEgoRaw=100., frogpilot_toggles=None):
    ...
    if CP.carFingerprint in CANFD_CAR and frogpilot_toggles and frogpilot_toggles.taco_tune_hacks:
      ...
      self.STEER_DELTA_DOWN = 10 if vEgoRaw < 14. else 3
...
class CAR(Platforms):
  ...
  HYUNDAI_IONIQ_6 = HyundaiCanFDPlatformConfig(
    ...
    flags=HyundaiFlags.EV | HyundaiFlags.CANFD_HDA2 | HyundaiFlags.CANFD_HDA2_ALT_STEERING | HyundaiFlags.CANFD_NO_RADAR_DISABLE,
  )
