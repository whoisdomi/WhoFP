...
std::unordered_map<std::string, uint32_t> keys = {
    ...
    {"LaneChangeDuration", PERSISTENT},
    {"LaneChangeJerkResponse", PERSISTENT},
    {"LaneChangeLateralAccel", PERSISTENT},
    ...
    {"PostTurnSmoothingTime", PERSISTENT},
    ...
    {"TacoTune", PERSISTENT},
    {"TacoTuneDeltaDown", PERSISTENT},
    {"TacoTuneDeltaUp", PERSISTENT},
    {"TacoTuneHacks", PERSISTENT},
    {"TacoTuneMaxSteer", PERSISTENT},
    ...
    {"TurnLatSmooth", PERSISTENT},
    {"TurnLeftBiasPercent", PERSISTENT},
    {"TurnRightBiasPercent", PERSISTENT},
