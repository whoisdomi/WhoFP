...
private:
  ...
  QSet<QString> advancedLateralTuneKeys = {"ForceAutoTune", "ForceAutoTuneOff", "ForceTorqueController", "LatSmoothSeconds", "LowPassFilterAlpha", "SteerDelay", "SteerFriction", "SteerKf", "SteerKi", "SteerKP", "SteerLatAccel", "SteerRatio"};
